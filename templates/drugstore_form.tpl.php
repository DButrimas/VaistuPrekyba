<ul id="pagePath">
	...
	<li><a href="index.php?module=<?php echo $module; ?>&action=list">Vaistines</a></li>
	<li><?php if(!empty($id)) echo "Vaistines redagavimas"; else echo "Nauja Vaistine"; ?></li>
</ul>
...
<div id="formContainer">
	...
	<form action="" method="post">
		<fieldset>
			<legend>Vaistines informacija</legend>
				<p>
			...
			<p>
				...
				<?php if(key_exists('telefono_nr', $maxLengths)) echo "<span class='max-len'>(iki {$maxLengths['telefono_nr']} simb.)</span>"; ?>
                         ...
                         <p>
				<label class="field" for="tinklapis">tinklapis<?php echo in_array('tinklapis', $required) ? '<span> *</span>' : ''; ?></label>
				<input type="text" id="tinklapis" name="tinklapis" class="textbox textbox-150" value="<?php echo isset($data['tinklapis']) ? $data['tinklapis'] : ''; ?>" />
				<?php if(key_exists('tinklapis', $maxLengths)) echo "<span class='max-len'>(iki {$maxLengths['tinklapis']} simb.)</span>"; ?>
			</p>
                         <p>
				...
				<?php if(key_exists('el_pasto_adresas', $maxLengths)) echo "<span class='max-len'>(iki {$maxLengths['el_pasto_adresas']} simb.)</span>"; ?>
                        ...
                        <p>
				<label class="field" for="darbo_laikas">darbo_laikas<?php echo in_array('darbo_laikas', $required) ? '<span> *</span>' : ''; ?></label>
